...
// Preferencias personales del usuario, persistidas en localStorage (no en la DB).
// Se extrajo a este componente cliente para que la página de Preferencias pueda
// ser un Server Component (necesario para leer rol/agencia y montar el editor del
// teléfono de la agencia, que sí va a la DB).
